...
RUN_USER_NAME="$(id -un)"
RUN_USER_ID="$(id -u)"
RATE_LIMIT_STATE_FILE="${RATE_LIMIT_STATE_FILE:-/tmp/ww-manage-last-run-${RUN_USER_NAME}-${RUN_USER_ID}}"
RATE_LIMIT_LOCK_FILE="${RATE_LIMIT_LOCK_FILE:-/tmp/ww-manage-lock-${RUN_USER_NAME}-${RUN_USER_ID}}"
