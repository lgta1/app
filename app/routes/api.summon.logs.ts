...
// New endpoint replacing /api/summon/history to avoid adblock/privacy filter issues.
// Mirrors the logic of api.summon.history.ts. Old endpoint kept temporarily for compatibility.
