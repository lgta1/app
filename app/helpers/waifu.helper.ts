...
export type SelectedWaifu = {
  id: string;
  name?: string;
  filename?: string; // e.g. "mitsuri cdn.hoangsatruongsalacuavietnam.site-1756571970280-47bb08f5.webp"
};
...
/** Build URL ?nh tinh t? thu m?c public b?n dang d�ng: /public/images/waifu */
export function buildWaifuStillUrl(filename?: string): string | null {
  return filename ? `/images/waifu/${filename}` : null;
}

/** L?y filename t? URL (b? query/hash), d�ng khi luu ��?ng h�nh� */
