          ...
          <div className="mb-3 flex items-center justify-between gap-3">
            ...
            <label className="relative w-full">
              ...
              <input
                ...
                className="w-full rounded-md border border-bd-default bg-bgc-layer2 pl-8 pr-3 py-2 text-base md:text-sm outline-none focus:ring-2 focus:ring-primary/40"
              />
            </label>
